...
namespace TeamSpeak3QueryApi.Net.Specialized
{
    public class TeamSpeakClient : IDisposable
    {
        ...
        public async Task<CreatedChannel> CreateChannel(string name, EditChannelInfo? channelInfo = null)
        {
            ...
            if (channelInfo != null)
                queryParameters.AddRange(channelInfo.ToQueryParameters());

            var res = await Client.Send("channelcreate", queryParameters.ToArray())
                .ConfigureAwait(false);
